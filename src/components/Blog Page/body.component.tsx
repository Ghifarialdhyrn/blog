...
export function Body() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto flex flex-row py-10">
        <div className="w-[75%] bg-white p-8 shadow-lg rounded-lg">
          {article && (
            ...
            <div className="flex justify-around">
              {[
                ...
                <Link href="#" key={idx} className="text-center">
                  ...
                  <p className="text-sm text-gray-600">{icon.followers}</p>
                </Link>
              ))}
            </div>
          </div>
